...
namespace KrillOrBeKrilled.Managers {
    ...
    public static class PlayerPrefsManager {
        ...
        /// </summary>
        /// <returns>
        /// If the mute SFX value in <see cref="PlayerPrefs"/> is equal to 1. If the skip dialogue
        /// key cannot be found in <see cref="PlayerPrefs"/>, returns false.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        /// If the mute music value in <see cref="PlayerPrefs"/> is equal to 1. If the skip dialogue
        /// key cannot be found in <see cref="PlayerPrefs"/>, returns false.
        /// </returns>
        ...
        /// <summary>
        /// Sets the value of the mute music PlayerPref.
        /// </summary>
        ...
        /// <summary>
        /// Sets the value of the mute SFX PlayerPref.
        /// </summary>
        ...
        /// </summary>
        /// <returns>
        /// If the skip dialogue value in <see cref="PlayerPrefs"/> is equal to 1. If the skip dialogue
        /// key cannot be found in <see cref="PlayerPrefs"/>, returns false.
        /// </returns>
